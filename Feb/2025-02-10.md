...
- 정형 데이터는 표나 데이터베이스처럼 행(Row)과 열(Column)의 구조를 가진 체계적인 데이터이다.</br>
    ![alt text](/Feb/image/structureddata.png)
...
- 누적 히스토그램</br>
  ...
  ```
  출력
  ![alt text](/Feb/image/chistogram.png)
...
- 산점도는 `plt.scatter()`메서드를 이용해 그릴 수 있다.</br>
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/scatter.png)
...
- 박스 플롯은 `plt.boxplot()`메서드를 사용하여 생성 가능하다.
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/boxplot.png)
...
- 다중 그래프를 사용하기 위해서는 `plt.subplots()`를 사용하여 그래프를 배치하고 필요에 따라 공유 축, 스타일 조정, 다양한 시각화 기법을 사용할 수 있다.
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/multiple.png)
...
- Seaborn을 활용한 막대그래프</br>
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snsbarchart.png)
...
- Seaborn을 활용한 박스 플롯</br>
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snsboxplot.png)
...
- Seaborn을 활용한 데이터 밀도와 분포(바이올린 플롯)
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snsviolin.png)
...
- Seaborn을 활용한 히스토그램</br>
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snshist.png)
  ```python
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snshistkde.png)
...
- Seaborn을 활용한 선 그래프</br>
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snslineplot.png)
...
- Seaborn을 활용한 산점도</br>
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snsscatter.png)
  ```python
  plt.figure(figsize=(8, 6))
  ...
  ```
  출력</br>
  ![alt text](/Feb/image/snsscatterwithline.png)
...
- 회귀선이 포함된 산점도 등으로 데이터간의 관계를 나타낼 수 있으며 `sns.pairplot()`을 이용해 여러 변수 간의 관계를 한 번에 시각화할 수 있다.
  ...
  ```
  출력
  ![alt text](/Feb/image/snspairplot.png)
